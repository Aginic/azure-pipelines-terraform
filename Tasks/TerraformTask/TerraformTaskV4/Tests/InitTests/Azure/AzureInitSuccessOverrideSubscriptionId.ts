...
let tp = path.join(__dirname, './AzureInitSuccessOverrideSubscriptionIdL0.js');
...
tr.setInput('backendAzureRmSubscriptionId', 'DummyResourceGroup');
...
process.env['ENDPOINT_DATA_AzureRM_SUBSCRIPTIONID'] = 'OverriddenSubscriptionId';
